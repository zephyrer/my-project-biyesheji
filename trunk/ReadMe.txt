...
WandererView.h, WandererView.cpp - the view of the document
    These files contain your CWandererView class.
    CWandererView objects are used to view CWandererDoc objects.
